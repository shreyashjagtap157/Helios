...
mod integration_tests {
    ...
    use crate::semantic::monomorphization::{TypeSubstitution, ExpressionSubstitutor};
    ...
    fn test_borrow_checking_workflow() {
        ...
        // Declare a variable
        checker.bind_variable("my_vec".to_string()).expect("declare should work");

        // Borrow it immutably
        checker.borrow_shared("my_vec").expect("borrow should work");

        // Can borrow again immutably
        checker.borrow_shared("my_vec").expect("second borrow should work");
    ...
    fn test_monomorphization_workflow() {
        ...
        let generic_type = Type::Generic("Vec".to_string(), vec![
